...
DB_PATH = os.environ.get("INI_DB_PATH", os.path.join(os.path.dirname(__file__), "ini_sessions.db"))
...
def save_session(session_id: str, title: str, created_at: str, messages: List[Dict[str, Any]]) -> None:
...
def load_session(session_id: str) -> Optional[Dict[str, Any]]:
    ...
    return {"session_id": sid, "title": title, "created": created_at, "updated": updated_at, "messages": msgs}
