...
from api.doaj_knowledge import (
    format_doaj_prompt_context,
    retrieve_doaj_context,
)
from api.openalex_knowledge import (
...
def generate_dynamic_answer_result(
    ...
    **_ignored: Any,
    ...
    system_prompt = (
        ...
        "- Separate established mechanisms from plausible associations, and avoid turning a possible influence into a primary causal factor.\n"
